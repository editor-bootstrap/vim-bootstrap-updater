...
class VimBootstrapUpdaterTests(unittest.TestCase):
    ...
    def test_generate_vimrc_200(self, mock_urlopen):
    ...
    @mock.patch('vim_bootstrap_updater.urllib2.urlopen')
    def test_generate_vimrc_NOT_200(self, mock_urlopen):
    ...
    @mock.patch('vim_bootstrap_updater._generate_vimrc',
                return_value='fake vimrc')
